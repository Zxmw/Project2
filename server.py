...
parser.add_argument('-iid', '--IID', type=int, default=1,
                    help='the way to allocate data to clients')

"""hyperparameters for this task"""
parser.add_argument('-dpath', '--dataset_path', type=str,
                    default='./concreteCrackSegmentationDataset', help='where the data is located')
parser.add_argument('-tf', '--test_frac', type=float,
                    default=0.15, help='the fraction of the test data')
parser.add_argument('-imgw', '--image_width', type=int,
                    default=480, help='the width of most input images')
parser.add_argument('-imgh', '--image_height', type=int,
                    default=320, help='the height of most input images')
...
if __name__ == "__main__":
    ...
    myClients = ClientsGroup(dataSetName='ConcreteCrack', data_set_path=args['dataset_path'], input_image_height=args['image_height'], input_image_width=args[
                             'image_width'], isIID=args['IID'], numOfClients=args['num_of_clients'], dev=dev, batchsize=args['batchsize'], test_frac=args['test_frac'])
