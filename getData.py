...
class SegmentationDataSet(Dataset):
    def __init__(self, rootdir, labeldir, img_name_ls, label_name_ls, transform=None, input_image_height=320, input_image_width=480):
    ...
    def set_img_name_ls(self, new_img_name_ls):
        self.img_name_ls = new_img_name_ls
        self.data_len = len(new_img_name_ls)


class GetDataSet(object):
    def __init__(self, dataSetName, transform, dataset_path, batch_size=64, isIID=True, test_frac=0.15):
    ...
    def ConcreteCrackDataSetConstruct(self, isIID, test_split=0.15):
        ...
        trainDS = SegmentationDataSet(
            image_dataset_path, mask_dataset_path, trainImages, trainMasks, transform=self.transform)
        testDS = SegmentationDataSet(
            image_dataset_path, mask_dataset_path, testImages, testMasks, transform=self.transform)
